...
def fetch_data_from_drive(folder_url, gcp_credentials_info):
    try:
        ...
        if not folder_id:
            return None, "Folder ID is missing in your Streamlit Secrets."
        ...
        if not items:
            return None, "Folder is empty. Upload your Excel file to Drive."
